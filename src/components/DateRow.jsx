export default function DateRow({date}) {
    ...
    const {estado, patient:{nombre}, fecha_destino, espec:{nombre_especialidad}} = date
    ...
    const [fecha, hora] = formatDate(new Date(fecha_destino)).split(' ');
    ...
    return (
        <tr className="bg-gray-100 border border-gray-300 md:border-none block md:table-row">
            ...
            <td className="p-2 md:border md:border-gray-300 text-left block md:table-cell">{estado}</td>
            <td className="p-2 md:border md:border-gray-300 text-left block md:table-cell">{fecha}</td>
            <td className="p-2 md:border md:border-gray-300 text-left block md:table-cell">{hora}</td>
            <td className="p-2 md:border md:border-gray-300 text-left block md:table-cell">{nombre}</td>
            <td className="p-2 md:border md:border-gray-300 text-left block md:table-cell">{nombre_especialidad}</td>
            <td className="p-2 md:border md:border-gray-300 text-left block md:table-cell">
